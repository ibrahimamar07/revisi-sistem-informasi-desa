...
<a href="{{ route('tenaga-pendidik.surat-masuk.create') }}" class="btn btn-primary">
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($surat->path)
                                <a href="{{ route('tenaga-pendidik.surat-masuk.download', $surat) }}" 
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                <a href="{{ route('tenaga-pendidik.surat-masuk.show', $surat) }}" 
                                   class="btn btn-sm btn-info" title="Detail">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('tenaga-pendidik.surat-masuk.edit', $surat) }}" 
                                   class="btn btn-sm btn-warning" title="Edit">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="{{ route('tenaga-pendidik.surat-masuk.destroy', $surat) }}" 

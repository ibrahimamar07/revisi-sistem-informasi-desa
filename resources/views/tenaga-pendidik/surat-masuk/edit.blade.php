...
<div class="container">
    ...
    <form action="{{ route('tenaga-pendidik.surat-masuk.update', $suratMasuk->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <a href="{{ route('tenaga-pendidik.surat-masuk.index') }}" class="btn btn-secondary">Batal</a>
    </form>
</div>
@endsection
